...
static struct crl_register_write_rep
	...
	{0x31a3, CRL_REG_LEN_08BIT, 0x08},  //00-4lane, 08-2lane
	...
	{0x31fe, CRL_REG_LEN_08BIT, 0x03},  //0f-4lane, 03-2lane
	...
	{0x30a2, CRL_REG_LEN_08BIT, 0x00},
	{0x30a3, CRL_REG_LEN_08BIT, 0x04},
	{0x30a4, CRL_REG_LEN_08BIT, 0x07},
	{0x30a5, CRL_REG_LEN_08BIT, 0x8b},
	{0x30a6, CRL_REG_LEN_08BIT, 0x04},
	{0x30a7, CRL_REG_LEN_08BIT, 0x43},
	{0x30a8, CRL_REG_LEN_08BIT, 0x00},
	...
	{0x3195, CRL_REG_LEN_08BIT, 0x0f},
	{0x315a, CRL_REG_LEN_08BIT, 0x01},
	{0x315b, CRL_REG_LEN_08BIT, 0x00},
	{0x30bb, CRL_REG_LEN_08BIT, 0x42},
...
static struct crl_ctrl_data ov2775_v4l2_ctrls[] = {
	{
...
//	.ctrl_items = ARRAY_SIZE(ov2775_v4l2_ctrls),
//	.ctrl_bank = ov2775_v4l2_ctrls,
